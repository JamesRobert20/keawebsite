            ...
            <div className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-6 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        {/* Main Heading */}
                        <h1
                            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight mb-6 animate-fade-in-up delay-100"
                        ...
                        <p className="text-lg md:text-xl text-stone mb-10 max-w-xl leading-relaxed animate-fade-in-up delay-200">
                            We partner with local farmers to supply quality maize, beans,
                            rice, and cassava directly to grocery chains, restaurants, and
                        ...
                        <div className="relative">
                            ...
                            <div className="relative card-glass rounded-3xl p-8">
                                ...
                                <div className="text-center">
                                    <div
                                        className={`w-40 h-40 mx-auto mb-6 rounded-full bg-gradient-to-br ${crops[activeCrop].color} flex items-center justify-center transition-all duration-500 shadow-2xl`}
                                    >
                                        <span className="text-7xl">
                                            {crops[activeCrop].emoji}
                                        </span>
                                    </div>
                                    <h3
                    ...
                    {[
                        {
                            ...
                            description:
                                'Maize, beans, rice, cassava and more — all from one trusted supplier.'
                        },
                        {
                            icon: '🤝',
                            title: 'Farm Partnerships',
                            description:
                                'Direct relationships with 500+ Tanzanian farmers for reliable supply.'
                        },
                        {
                            icon: '✅',
                            title: 'Quality Assured',
                            description:
                                'Rigorous quality control ensures only the best reaches your business.'
                        },
                        {
                            icon: '🚚',
                            title: 'B2B Delivery',
                            description:
                                'Reliable supply to grocery chains, restaurants, and businesses.'
                        }
                    ].map((feature, index) => (
                        <div
                            key={feature.title}
