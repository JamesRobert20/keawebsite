                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-stone text-sm leading-relaxed mb-6">
                            Connecting Tanzanian farmers directly to grocery chains,
                            restaurants, and businesses. Quality crops, reliable supply.
                        </p>
                        {/* Crop Icons */}
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={link.href}>
                                    ...
                                    >
                                        <svg
                                            className="w-4 h-4 mr-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-primary"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
