...
const products = [
    {
        ...
        emoji: '🌽',
        description:
            'High-quality maize grain, meticulously cleaned and sorted. Perfect for milling into flour, making ugali, or direct cooking applications.',
        details: [
    ...
    },
    {
        ...
        emoji: '🌾',
        description:
            'Bulk white maize for commercial operations. Consistent quality, cleaned and ready for your processing needs.',
        details: [
    ...
    },
    {
        ...
        emoji: '🫘',
        description:
            "Protein-rich red kidney beans from Tanzania's highlands. Ideal for restaurants, grocery retailers, and food manufacturers.",
        details: [
    ...
    },
    {
        ...
        emoji: '🫛',
        description:
            'A diverse selection of locally grown beans including black-eyed peas, butter beans, and more. Perfect for retailers.',
        details: [
    ...
    },
    {
        ...
        emoji: '🍚',
        description:
            "Aromatic long-grain rice from Tanzania's fertile paddy fields. Perfect for everyday meals and special occasions.",
        details: [
    ...
    },
    {
        ...
        emoji: '🥔',
        description:
            'Quality cassava roots from local farms. A versatile staple for various culinary applications, from chips to flour.',
        details: [
    ...
    },
    {
        ...
        emoji: '🥣',
        description:
            'Finely milled maize flour for authentic ugali and traditional Tanzanian dishes. Made from quality Tanzanian maize.',
        details: [
    ...
    },
    {
        ...
        emoji: '🐔',
        description:
            'Quality maize for animal feed production. Consistent quality meeting nutritional requirements for poultry and livestock.',
        details: [
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-xl text-stone leading-relaxed">
                            Quality maize, beans, rice, cassava, and more — all sourced
                            directly from Tanzanian farmers and delivered to your
                            business.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 flex flex-wrap gap-6">
                        {[
                            ...
                            <div
                                key={stat.label}
                                className="card-glass rounded-xl px-6 py-4"
                            >
                        ...
                        {products.map(product => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row">
                                    {/* Product Visual */}
                                    <div
                                        className={`${product.bgColor} p-8 flex items-center justify-center md:w-2/5 relative overflow-hidden`}
                                    >
                                        <div
                                            className={`w-32 h-32 rounded-3xl bg-gradient-to-br ${product.color} flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-500`}
                                        >
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-stone max-w-2xl mx-auto">
                            Every crop we deliver meets strict quality standards for your
                            business.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description:
                                    'Each batch is carefully selected from trusted farmers who meet our quality criteria.'
                            },
                            {
                                icon: '📋',
                                title: 'Testing & Grading',
                                description:
                                    'Products undergo testing for moisture, contaminants, and grading standards.'
                            },
                            {
                                icon: '📦',
                                title: 'Proper Packaging',
                                description:
                                    'Quality packaging that preserves freshness and protects products during transit.'
                            }
                        ].map(item => (
                            <div
                                key={item.title}
                                className="text-center p-8 card-glass rounded-2xl hover:-translate-y-1 transition-all duration-300"
                            >
                        ...
                        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                            <div>
                                ...
                                <p className="text-white/80 mb-6">
                                    We&apos;re constantly working to bring you more
                                    variety. New crops and products are being added.
                                </p>
                                <Link
                                    href="/contact"
            ...
            <section className="py-16 bg-gradient-to-r from-primary via-primary-light to-accent relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-6 md:px-10 text-center">
                    ...
                    <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
                        Contact us for custom quotes, bulk pricing, and delivery options
