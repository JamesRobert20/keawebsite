                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-xl text-stone leading-relaxed">
                            Whether you need bulk maize, beans for your restaurant, or a
                            variety of crops for your grocery chain — our team is ready to
                            help.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <p className="text-stone mb-8 leading-relaxed">
                                Reach out through any of these channels. We typically
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex space-x-3">
                                    {[
                                        {
                                            label: 'Facebook',
                                            icon: 'M12 2C6.477 2 2 6.477 2 12c0 5.013 3.693 9.153 8.505 9.876V14.65H8.031v-2.629h2.474v-1.749c0-2.896 1.411-4.167 3.818-4.167 1.153 0 1.762.085 2.051.124v2.294h-1.642c-1.022 0-1.379.969-1.379 2.061v1.437h2.995l-.406 2.629h-2.588v7.247C18.235 21.236 22 17.062 22 12c0-5.523-4.477-10-10-10z'
                                        },
                                        {
                                            label: 'Twitter',
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-10">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-stone">
                            Visit our office in Dar es Salaam, Tanzania
                        </p>
                    </div>
                ...
                <div className="max-w-3xl mx-auto px-6 md:px-10">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div
                                key={index}
                                className="card rounded-xl p-6 hover:-translate-y-1 transition-all duration-300"
                            >
